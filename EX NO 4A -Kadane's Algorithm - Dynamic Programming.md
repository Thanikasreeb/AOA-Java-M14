...
1 <= n <= 10^6
## Algorithm
1. 1.Start the program and read the number of solar panels n and their energy values into an array.
...
## Output:
<img width="425" height="234" alt="image" src="https://github.com/user-attachments/assets/d44937ff-956e-4c09-a271-b22dbd5a30ff" />
