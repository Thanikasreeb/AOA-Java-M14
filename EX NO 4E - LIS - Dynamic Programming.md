...
If nums[i] > nums[j], it means we can extend the subsequence ending at j. → Update dp[i] = max(dp[i], dp[j] + 1)
...
## Output:
<img width="812" height="257" alt="image" src="https://github.com/user-attachments/assets/e5d627ed-e324-4ff8-9318-29a413f60ea6" />
